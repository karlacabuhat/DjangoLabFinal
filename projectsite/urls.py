...
urlpatterns = [
    ...
    path('orgmem_list/', OrgMemberList.as_view(), name='orgmember-list'),
    path('orgmem_list/add', OrgMemberCreateView.as_view(), name='orgmember-add'),
    path('orgmem_list/<pk>', OrgMemberUpdateView.as_view(), name='orgmember-update'),
    path('orgmem_list/<pk>/delete' , OrgMemberDeleteView.as_view(), name= 'orgmember-delete'),
